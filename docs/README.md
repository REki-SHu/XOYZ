...
This directory contains all design documents, architecture notes, and implementation guides for the XOYZ game.
...
| [BUILD_GUIDE.md](BUILD_GUIDE.md) | Detailed build & environment setup guide |
